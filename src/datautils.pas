...
type
  ...
  generic THashtableEntry<T> = record
    Data: Pointer;
  ...
  private
    ...
    function CreateEntry(const Index: T; IndexHash: Cardinal): PHashtableEntry;
    function FindHash(const Index: T; CreateIfRequired: Boolean = false): PHashtableEntry;
    function GetHash(const Index: T): Cardinal;
    procedure Grow;
  protected
  public
    constructor Create;
    ...
    function Get(Index: T): Pointer;
    procedure Add(Index: T; const Value: Pointer);
    function Find(Index: T; var Data: Pointer): Boolean;
    function GetNext(var Hash: KString; var Data: Pointer): Boolean;
    function DeleteKey(const Index: T): Boolean;
    property Key[Index: T]: Pointer read Get write Add; default;
  end;
  ...
  public
    ...
    property RawItems[Item: Integer]: TSparseListItem read GetRawItem;
  end;
